...
% k is the speed up factor. This file calculates the steady state 
% probability and the response time for the k value specify here: 
k = 2.86;
    ...
    % =6/k*(x(1)+x(2)+x(3))
    system_throughput = 6*k*(x(1)+x(2)+x(3));

    % The response time is
    response_time = 2 / system_throughput
